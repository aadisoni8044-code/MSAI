...
class SidebarController {
  ...
  init() {
    ...
    this.btnHeaderMobileSidebar = document.getElementById('btnHeaderMobileSidebar');
  ...
  setupEvents() {
    ...
    if (this.btnHeaderMobileSidebar) {
      this.btnHeaderMobileSidebar.addEventListener('click', () => {
        this.toggleMobileSidebar();
      });
    }

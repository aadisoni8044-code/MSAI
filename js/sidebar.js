...
export class Sidebar {
  ...
  renderChatItem(conv, isActive) {
    ...
    return `
      <div class="chat-item-wrapper ${isActive ? "active" : ""}" data-chat-id="${conv.id}" id="chat-item-${conv.id}">
        <button class="chat-item-btn" title="${title}">
        ...
        <div class="chat-item-actions">
          <button class="chat-action-menu-btn" data-chat-id="${conv.id}" title="Options" aria-label="Conversation options">
          ...
          <div class="chat-dropdown-menu" id="dropdown-${conv.id}">
            <button class="dropdown-item rename-chat-btn" data-chat-id="${conv.id}">
            ...
            <button class="dropdown-item pin-chat-btn" data-chat-id="${conv.id}">
            ...
            <button class="dropdown-item export-chat-btn" data-chat-id="${conv.id}">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
              <span>Export Markdown</span>
            </button>
            <div class="dropdown-divider"></div>
            <button class="dropdown-item delete-chat-btn delete-danger" data-chat-id="${conv.id}">

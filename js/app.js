...
import { pricingController } from './pricing.js';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 9. Initialize Chat Flow & Composer
  chatController.init();

  // 9b. Initialize Pricing / Subscription Plans Screen
  pricingController.init();

  // 10. Setup Global Keyboard Shortcuts
  setupKeyboardShortcuts();

  // 11. Initialize API readiness
  initializeAPI();

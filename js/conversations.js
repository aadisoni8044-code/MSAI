...
class ConversationManager {
  ...
  createNewConversation(initialTitle = "New Conversation", model = null) {
  ...
  async updateTitle(newTitle) {
    ...
    await this.renameConversation(this.currentConversation.id, newTitle);
  }
  ...
  async renameConversation(id, newTitle) {
    ...
    if (this.currentConversation && this.currentConversation.id === id) {
      this.currentConversation.title = cleanTitle;
      this.currentConversation.updatedAt = new Date().toISOString();
      await storage.saveConversation(this.currentConversation);
  ...
  // Get messages formatted for AI API context
  getHistoryForAPI() {
